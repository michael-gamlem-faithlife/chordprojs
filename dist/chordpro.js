...
},{"./lib/song":6}],5:[function(require,module,exports){
'use strict';
...
function Chord(chordText, transposeProperties) {
    ...
    if (chordText.match(/\w+/)) this.chordMagicked = chordMagic.parse(chordText);else this.text = chordText;
}
...
Chord.prototype.getOrigText = function () {
    if (this.chordMagicked) return chordMagic.prettyPrint(this.chordMagicked);else return this.text;
};
...
},{"./chords":5,"lodash":2,"mustache":3}]},{},[4])(4)
});
